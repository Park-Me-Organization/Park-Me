/* function updateRoute() {
  ...
  function getResults(long,lat) {
    ...
    var query = 'https://api.mapbox.com/geocoding/v5/mapbox.places/parking.json?limit=10&proximity=' + long +","+lat+'&types=poi&access_token=pk.eyJ1IjoicmFmYWVsaGR6YSIsImEiOiJja2dzeHJjbnMwZzE3MnJtNWV6cHVsam9sIn0.7oigwdpk6AYK5VqUZq3phg';
    var $ = require( "jquery" );
    $.ajax({
      method: 'GET',
      url: query
